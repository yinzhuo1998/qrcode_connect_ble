...
public class Constants {
	...
	// 找到新设备
	public static final int FIND_NEW_DEVICE = 101010;

	// 找到服务
	public static final int FIND_SERVICES = 101011;

	// 读
	public static final int CHARACTERISTIC_READ = 102010;

	// 通知
	public static final int CHARACTERISTIC_NOTIFY = 102011;
	...
	/** 特征UUID1 */
	public static final String BLE_CHARACTERISTIC_UUID_1 = "0000fff1-0000-1000-8000-00805f9b34fb";
	/** 特征UUID2 */
	public static final String BLE_CHARACTERISTIC_UUID_2 = "0000fff2-0000-1000-8000-00805f9b34fb";
